(function($) {
    ...
    return this.each(function() {
      ...
      (function shuffle(start) {
        ...
        for (i = Math.max(start, 0); i < len; i++) {
          ...
          if (i < start + options.step /* + (Math.random() * options.randomVariance) - options.randomVariance */) {
  ...
  var container_letters = $("span, p, .shuffleme");

  // Loop
  function loop() {
    //container.shuffleLetters({ callback:loop });
    container_letters.shuffleLetters({});
  }
  loop();
